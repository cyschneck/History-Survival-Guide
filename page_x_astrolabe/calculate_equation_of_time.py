...
def plotEffectOfEccentricty(planet_name, effect_of_eccentricity_dict):
	...
	plt.title("{0}: Difference Between Dynamical Mean and True Solar Time - Effect of Eccentricity (Min: {1}, Max: {2} )".format(planet_name,
																																min(y_clock_minutes),
																																max(y_clock_minutes)))
